<?php
  ...
  $data_user =query("SELECT user.nama, user.email, tb_log.time_log FROM tb_log INNER JOIN user ON tb_log.id_user = user.id_user WHERE level = 'mahasiswa' OR level = 'dosen' OR level = 'staff'");
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Data User</a>
          </div>
